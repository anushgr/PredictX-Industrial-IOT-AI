...
def health() -> dict:
    return {
        ...
        "mqtt_topic_config": settings.mqtt_topic,
        "mqtt_qos_config": settings.mqtt_qos,
        "mqtt_keepalive_config": settings.mqtt_keepalive,
        "mqtt_client_id": ingestion_service.mqtt_client_id,
        "mqtt_subscribed_topic": ingestion_service.subscribed_topic,
        "mqtt_subscribe_result": ingestion_service.subscribe_result,
        "mqtt_received_messages": ingestion_service.received_messages,
        "mqtt_last_received": ingestion_service.last_received_message,
